...
app.layout = html.Div([
    ...
    html.Div([ # For Graph of crypto
        html.Div([
            dcc.Tabs(id="Graph_index", value="Graph", children=[
                dcc.Tab(label="Graph", value="Graph", style=tab_style, selected_style=tab_selected_style),
                dcc.Tab(label="Index", value="Index", style=tab_style, selected_style=tab_selected_style),
            ]),
        ]),
        html.Div([
...
@app.callback(
    ...
    [Input("crypto_dropdown", "value"), Input("Graph_index", "value")])
def crypto_graph(value,value1):
    ...
    if value1 == "Graph":
        return fig
    else: #set up Fear and Greed index
